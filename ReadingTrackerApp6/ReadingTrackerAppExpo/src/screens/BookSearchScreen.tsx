...
import { View, Text, TextInput, StyleSheet, ScrollView, ActivityIndicator, TouchableOpacity, Keyboard } from 'react-native';
...
const BookSearchScreen = ({ navigation }: any) => {
  ...
  const handleManualAdd = () => {
    setSnackbar({ visible: true, message: '직접 입력으로 책이 추가되었습니다!' });
    navigation.goBack && navigation.goBack();
  };
